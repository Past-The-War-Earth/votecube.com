...
export const VARIATION_LIST: Route_Path      = '/variation/List/:pollKey/:pollVariationKey'
export const POLL_FORM: Route_Path           = '/poll/Form/:mode'
export const POLL_MAIN: Route_Path           = '/poll/Main/:mode/:pollKey/:pollVariationKey'
