...
export const DERIVATION_LIST: Route_Path      = '/situation/List/:repositoryUuId'
export const SITUATION_FORM: Route_Path           = '/situation/Form/:mode'
export const SITUATION_MAIN: Route_Path           = '/situation/Main/:mode/:repositoryUuId'
