...
export const SITUATION_LIST: Route_Path           = '/poll/List'
export const VARIATION_LIST: Route_Path      = '/revision/List/:repositoryUuId'
export const SITUATION_FORM: Route_Path           = '/poll/Form/:mode'
export const SITUATION_MAIN: Route_Path           = '/poll/Main/:mode/:repositoryUuId'
export const SITUATION_LOCATIONS: Route_Path      = '/poll/Locations/:mode'
export const SITUATION_TIME_FRAME: Route_Path     = '/poll/TimeFrame/:mode'
