...
import { Factor_Id, ICoreFactorBase } from './Factor';
import { ICoreOutcome, Outcome_Id } from './Outcome';
...
export declare type Poll_Name = string;
...
export interface ICoreFactorPoll<Doc extends DocStatus> extends ICorePoll<Doc> {
    factorId: Factor_Id;
}
export interface ICoreOutcomePoll<Doc extends DocStatus> extends ICorePoll<Doc> {
