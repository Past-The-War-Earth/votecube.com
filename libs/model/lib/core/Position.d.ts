...
export declare type Position_Id = Id;
export declare type Position_Name = string;
export declare type Position_Dir = -1 | 1 | 0;
...
export interface ICorePositionFromForm<Doc extends DocStatus> {
    name: Doc extends IsDoc ? IDocumentValue<Position_Name> : Doc extends IsDelta ? boolean : Position_Name;
}
