import { Id, IsDelta } from '../core/common';
...
export interface IUiFactorPoll<Doc extends UiDocStatus> extends IUiPoll<Doc> {
    factorId: Factor_Id;
}
export interface IUiOutcomePoll<Doc extends UiDocStatus> extends IUiPoll<Doc> {
