 ...
 */
class PollStateSerializer extends ModelSerializer_1.ModelSerializer {
    constructor() {
        super(model_1.EntityType.PLL_STT);
    }
...
exports.PollStateSerializer = PollStateSerializer;
di_1.DI.set(tokens_1.AJAX_Z_POLL_STATE, PollStateSerializer);
