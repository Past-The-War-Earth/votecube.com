...
export interface IVCFirestore extends firestore.Firestore {
    collection<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(collectionPath: string): IVCCollectionReference<K, T, PK, PT>;
    doc<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(documentPath: string): IVCDocumentReference<K, T, PK, PT>;
    collectionGroup<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(collectionId: string): IVCQuery<K, T, PK, PT>;
...
export interface IVCTransaction extends firestore.Transaction {
    get<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(documentRef: IVCDocumentReference<K, T, PK, PT>): Promise<IVCDocumentSnapshot<K, T, PK, PT>>;
    set<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(documentRef: IVCDocumentReference<K, T, PK, PT>, data: T, options?: firestore.SetOptions): IVCTransaction;
    update<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(documentRef: IVCDocumentReference<K, T, PK, PT>, data: Partial<T>): IVCTransaction;
    update<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(documentRef: IVCDocumentReference<K, T, PK, PT>, field: string | firestore.FieldPath, value: any, ...moreFieldsAndValues: any[]): IVCTransaction;
    delete<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null>(documentRef: IVCDocumentReference<K, T, PK, PT>): IVCTransaction;
}
export interface IVCCollectionReference<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null> extends IVCQuery<K, T> {
...
export interface IVCDocumentReference<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null> extends firestore.DocumentReference {
    readonly parent: IVCCollectionReference<PK, PT>;
    collection<CK extends Id, CT extends IIdentified<CK>>(collectionPath: string): IVCCollectionReference<CK, CT, K, T>;
...
export interface IVCQuerySnapshot<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null> extends firestore.QuerySnapshot {
...
export interface IVCDocumentChange<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null> extends firestore.DocumentChange {
    readonly doc: IVCQueryDocumentSnapshot<K, T, PK, PT>;
}
export interface IVCDocumentSnapshot<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null> extends firestore.DocumentSnapshot {
    readonly ref: IVCDocumentReference<K, T, PK, PT>;
    data(options?: firestore.SnapshotOptions): T | undefined;
    isEqual(other: IVCDocumentSnapshot<K, T, PK, PT>): boolean;
}
export interface IVCQueryDocumentSnapshot<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null> extends firestore.QueryDocumentSnapshot {
    data(options?: firestore.SnapshotOptions): T;
}
export interface IVCQuery<K extends Id, T extends IIdentified<K>, PK extends Id = null, PT extends IIdentified<PK> = null> extends firestore.Query {
