import { IVersioned, Id } from '@votecube/model';
export interface IDbConverter {
    ...
    toVersionedDb<K extends Id, Ui extends IVersioned<K>, Delta, Db extends IVersioned<K>>(uiObject: Ui, deltas: Delta, originalDbObject: Db, directProperties: any[]): Db;
}
