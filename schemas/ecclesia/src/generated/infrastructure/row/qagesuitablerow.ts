...
import {
	AgeSuitableRow,
} from '../../../ddl/infrastructure/row/AgeSuitableRow';
...
export interface QAgeSuitableRowQRelation<SubType, SubQType extends IQEntity<SubType>>
	extends QImmutableActorRowQRelation<SubType, SubQType>, QAgeSuitableRowQId {
}
