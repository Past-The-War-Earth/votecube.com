...
let PollRunCountry = class PollRunCountry {
};
__decorate([
    air_control_1.GeneratedValue(),
    air_control_1.Id(),
    air_control_1.Column({ name: 'POLL_COUNTRY_ID' })
...
PollRunCountry = __decorate([
    ...
    air_control_1.Table({ name: 'POLL_COUNTRIES' })
], PollRunCountry);
exports.PollRunCountry = PollRunCountry;
