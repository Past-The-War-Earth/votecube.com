 ...
 *
 */
let OutcomeTranslation = class OutcomeTranslation extends ImmutableActorRow_1.ImmutableActorRow {
};
__decorate([
    air_control_1.Id(),
    air_control_1.GeneratedValue(),
    air_control_1.Column({ name: 'OUTCOME_TRANSLATION_ID' })
...
__decorate([
    ...
    air_control_1.JoinColumn({ name: 'OUTCOME_ID' })
...
OutcomeTranslation = __decorate([
    ...
    air_control_1.Table({ name: 'OUTCOME_TRANSLATIONS' })
], OutcomeTranslation);
exports.OutcomeTranslation = OutcomeTranslation;
