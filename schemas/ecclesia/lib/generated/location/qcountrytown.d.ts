 ...
 */
export interface QCountryTown extends QSystemGeneratedRow<CountryTown> {
...
export interface QCountryTownQRelation extends QSystemGeneratedRowQRelation<CountryTown, QCountryTown>, QCountryTownQId {
}
