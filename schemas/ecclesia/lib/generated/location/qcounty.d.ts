 ...
 */
export interface CountyGraph extends CountyEOptionalId, SystemGeneratedRowGraph {
    name?: string | IQStringField;
    state?: StateGraph;
...
export interface QCountyQRelation extends QSystemGeneratedRowQRelation<County, QCounty>, QCountyQId {
}
