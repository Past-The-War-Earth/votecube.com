...
export const IDEA_DVO = votecube.token<IdeaDvo>({
    class: IdeaDvo,
    interface: 'IIdeaDvo',
    token: 'IDEA_DVO'
})
...
export const IDEA_RATING_DVO = votecube.token<IdeaRatingDvo>({
    class: IdeaRatingDvo,
...
export const SITUATION_IDEA_DVO = votecube.token<SituationIdeaDvo>({
