...
import { FactorECascadeGraph, FactorEOptionalId, FactorESelect, QFactor, QFactorQRelation } from './qfactor';
 ...
 */
export interface FactorTranslationECascadeGraph extends ImmutableActorRowECascadeGraph {
