...
let PollRunCounty = class PollRunCounty {
};
__decorate([
    air_control_1.GeneratedValue(),
    air_control_1.Id(),
    air_control_1.Column({ name: 'POLL_COUNTY_ID' })
...
PollRunCounty = __decorate([
    ...
    air_control_1.Table({ name: 'POLL_COUNTIES' })
], PollRunCounty);
exports.PollRunCounty = PollRunCounty;
