...
let Continent = class Continent extends SystemGeneratedRow_1.SystemGeneratedRow {
};
__decorate([
    air_control_1.GeneratedValue(),
    air_control_1.Id(),
    air_control_1.Column({ name: 'CONTINENT_ID' })
], Continent.prototype, "id", void 0);
__decorate([
    air_control_1.Column({ name: 'CONTINENT_NAME', nullable: false })
], Continent.prototype, "name", void 0);
__decorate([
    air_control_1.OneToMany({ mappedBy: 'CONTINENT_ID' })
