...
import {
	PollFactorPositionRevision_Axis,
	PollFactorPositionRevision_Dir,
	PollFactorPositionRevision_Id
}                       from '../../../../types/poll/revision/structure/PollFactorPositionRevision'
...
@Entity()
@Table({name: 'POLL_FACTOR_POSITION_REVISIONS'})
export class PollFactorPositionRevision
	extends ImmutableRow {

	@GeneratedValue()
	@Id()
	@Column({name: 'POLL_FACTOR_POSITION_REVISION_ID'})
	id: PollFactorPositionRevision_Id

	@Column({name: 'FACTOR_COORDINATE_AXIS', nullable: false})
	@DbString()
	axis: PollFactorPositionRevision_Axis

	@Column({name: 'POSITION_ORIENTATION', nullable: false})
	@DbNumber()
	dir: PollFactorPositionRevision_Dir
	...
	@JoinColumn({
		...
		referencedColumnName: 'POLL_FACTOR_POSITION_REVISION_ID'
	})
	parent: PollFactorPositionRevision

	@OneToMany({cascade: CascadeType.ALL, mappedBy: 'parent'})
	children: PollFactorPositionRevision[]
}
