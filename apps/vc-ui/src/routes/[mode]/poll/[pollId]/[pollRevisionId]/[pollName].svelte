...
<script>
    ...
    import BuildButton        from '../../../../../components/common/control/button/BuildButton.svelte'
    import CancelButton       from '../../../../../components/common/control/button/CancelButton.svelte'
    import OutcomeButton      from '../../../../../components/common/control/button/OutcomeButton.svelte'
    import PercentPicker      from '../../../../../components/common/control/PercentPicker.svelte'
    ...
    import {setupCubeView} from '../../../../../libs/database'
...
// 				percentMode = false
    ...
    function alter($routeParams) {
        ...
        goto(`${$routeParams.mode}/poll/${$routeParams.pollId}/${$routeParams.pollRevisionId}/info`)
    }
    ...
    function goToRevisions() {
        ...
        goto(`list/poll/revisions/${pollId}/${pollRevisionId}`)
    }
